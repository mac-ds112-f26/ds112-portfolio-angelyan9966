---
title: "My first Quarto document_ICA_Sep 14"
author: "Angel Yan"
editor: 
  markdown: 
    wrap: sentence
...
Thoughts?
It has titles, paragraphs, and images
...
Not colorful but clean and organized
Can you edit it?
No, I cannot change the color. but I think I should do it in the .qmd file. .html is for output

Toggling between the .qmd and .html files, explain the purpose of the following features in the .qmd file:

`*`
It means italic *hello*
...
`\`
In quarto, it means escape / link break

`![](url)`
It means insert picture
...
For qmd it's a bunch of code, for markdown and R code
...
I need to only put seq() in the chunk that works. Both R code and output are in the .html
...
the_Number_of_Students_in_this_class <- 27
```
